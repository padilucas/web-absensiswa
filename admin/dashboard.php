		...
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="blue">
				...
				<a href="dashboard.php" class="logo">
					<img src="../assets/img/skultun.jpg" alt="navbar brand" class="navbar-brand" width="22">
		...
		<footer class="footer">
				<div class="container">
					<div class="copyright ml-auto">
						&copy; <?php echo date('Y');?> Absensi MTs Tadika Mesra (<a href="index.php">Fadia Meilita Pratiwi </a> | 2021)
					</div>				
				</div>
			</footer>
		</div>
