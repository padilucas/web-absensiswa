...
$tglTerakhir = date('t',strtotime($tglBulan));
 ...
 <table width="100%">
 	<tr>
 		<td>
			<img src="../../../assets/img/skultun.jpg" width="130"> 
 			<center>
 				
 				<h1>
 					ABSENSI SISWA <br>
 					<small> MTs TADIKA MESRA</small>
 				</h1>
 				<hr>
 				<em>
 					Jl.Kemuning Raya Rt.02 Rw.01 Melayu Selatan Kode Pos 59181 <br>
 				<b>Email : mtstadikamesra@gmail.com Telp.081222333444</b> 
 				</em>
...
<table width="100%">
	...
	<!-- 	<td align="left">
		...
		<td align="right">
			<p>
				Melayu Selatan, <?php echo date('d-F-Y'); ?>
			</p>
			<p>
				Kepala Sekolah
				<br>
